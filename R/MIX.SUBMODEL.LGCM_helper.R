#' @title Define Latent Growth Curve Models as Class-specific Models (Submodels) for a Longitudinal Mixture Model
#'
    ...
    for (k in 1:nClass){
      if (!is.null(growth_TIC)){
        ...
        class.list[[k]] <- mxModel(name = paste0("Class", k), type = "RAM",
                                   ...
                                   GF_loadings[[k]], mxFitFunctionML(vector = TRUE))
      }
    }
  }
      ...
      for (k in 1:nClass){
        if (!is.null(growth_TIC)){
          ...
          class.list[[k]] <- mxModel(name = paste0("Class", k), type = "RAM",
                                     ...
                                     mxAlgebraFromString(paste0("rbind(cbind(1, -c", k, "Y_knot, c", k, "Y_knot, c", k, "Y_mueta2s - c", k, "Y_mueta1s),",
                                                                "cbind(0, 1, -1, 0),",
                                                                "cbind(0, 1, 1, 0),",
