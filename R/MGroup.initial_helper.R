#' @title Compute Initial Values for Parameters of Multiple-group Models
#'
#' @description This function computes the initial values for the parameters for a longitudinal multiple-group model. The supported submodels
#' (i.e., class-specific models) include (1) latent growth curve models, (2) latent change  score models, (3) latent growth curve
#' models or latent change score models with a time varying covariate, (4) multivariate latent growth curve models or multivariate
#' latent change score models, (5) longitudinal mediation models. For the first three submodels, time-invariant covariates are allowed.
#'
