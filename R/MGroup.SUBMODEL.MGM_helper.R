...
#' variable for the corresponding outcome variable at each study wave. It takes the value passed from \code{getMGroup()}.
#' @param y_var A vector of strings, with each element representing the prefix for column names corresponding to a
#' particular outcome variable at each study wave. It takes the value passed from \code{getMGroup()}.
...
#' the corresponding outcome variable. It takes the value passed from \code{getMGroup()}.
#' @param y_model A string specifying how to fit the longitudinal outcome. Supported values are \code{"LGCM"} and \code{"LCSM"}.
#' It takes the value passed from \code{getMGroup()}.
#' @param starts A list of initial values for the parameters, either takes the value passed from \code{getMGroup()} or derived
#' by the helper function \code{getMGroup.initial()}.
#'
...
#'
getsub.MGM_m <- function(dat, nClass, grp_var, t_var, y_var, curveFun, intrinsic, records, y_model, starts){
