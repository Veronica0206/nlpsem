    ...
    if (curveFun %in% c("linear", "LIN")){
      ...
      if (decompose == 0){
        if (!is.null(growth_TIC)){
          ...
          for (p in 1:Y_nGF){
            BETA[[p]] <- mxPath(from = growth_TIC, to = latents[p], arrows = 1, free = TRUE, values = starts$beta[p, ],
                                labels = paste0("beta", p - 1, c(paste0("TIC", seq_along(growth_TIC)))))
          }
          model_mx <- mxModel(name = "LGCM with TVC and TICs, Linear Functional Form",
                              type = "RAM", mxData(observed = dat, type = "raw"),
                              manifestVars = manifests, latentVars = latents,
                              mxPath(from = "one", to = latents[1:2], arrows = 1, free = TRUE, values = starts$Y_starts$means,
                                     labels = c("Y_mueta0", "Y_mueta1")),
                              mxPath(from = latents[1:2], to = latents[1:2], arrows = 2, connect = "unique.pairs",
                                     free = TRUE, values = starts$Y_starts$covMatrix,
                              ...
                              mxPath(from = paste0(y_var, records), to = paste0(y_var, records), arrows = 2,
                                     free = TRUE, values = starts$Y_starts$residuals, labels = "Y_residuals"),
                              ...
                              mxPath(from = "one", to = paste0(TVC, records), arrows = 1, free = TRUE,
                                     values = starts$TVC_starts$means, labels = paste0("TVC_m", records)),
                              mxPath(from = paste0(TVC, records), to = paste0(TVC, records), arrows = 2, free = TRUE,
                                     values = starts$TVC_starts$covMatrix, labels = paste0("TVC_v", records)),
                              mxMatrix("Full", 2, length(growth_TIC), free = TRUE,
                                       values = starts$beta[1:2, seq_along(growth_TIC)],
                                       labels = c(paste0("beta0TIC", seq_along(growth_TIC)),
                                                  paste0("beta1TIC", seq_along(growth_TIC))), byrow = TRUE, name = "beta"),
                              mxMatrix("Full", length(growth_TIC), 1, free = TRUE, starts$BL_starts$means[seq_along(growth_TIC)],
                                       labels = c(paste0("mux", seq_along(growth_TIC))), byrow = FALSE, name = "mux"),
          ...
          model_mx <- mxModel(name = "LGCM with TVC, Linear Functional Form",
                              ...
                              mxPath(from = "one", to = latents[1:2], arrows = 1, free = TRUE, values = starts$Y_starts$means,
                                     labels = c("Y_mueta0", "Y_mueta1")),
                              mxPath(from = latents[1:2], to = latents[1:2], arrows = 2, connect = "unique.pairs",
                                     free = TRUE, values = starts$Y_starts$covMatrix, labels = c("Y_psi00", "Y_psi01", "Y_psi11")),
                              mxPath(from = "eta0Y", to = paste0(y_var, records), arrows = 1, free = FALSE, values = 1),
                              mxPath(from = "eta1Y", to = paste0(y_var, records), arrows = 1, free = FALSE, values = 0,
                                     labels = paste0("L1", records, "[1,1]")),
                              mxPath(from = paste0(y_var, records), to = paste0(y_var, records), arrows = 2,
        ...
        if (!is.null(growth_TIC)){
          nTICs <- length(growth_TIC)
          for (p in 1:Y_nGF){
            BETA[[p]] <- mxPath(from = c(growth_TIC, "lx1"), to = latents[p], arrows = 1, free = TRUE, values = starts$beta[p, ],
                                labels = paste0("beta", p - 1, c(paste0("TIC", seq_along(growth_TIC)), "TVC")))
          }
          model_mx <- mxModel(name = "LGCM with decomposed TVC and TICs, Linear Functional Form",
                              ...
                              mxMatrix("Full", 2, length(growth_TIC), free = TRUE,
                                       values = starts$beta[1:2, seq_along(growth_TIC)],
                                       labels = c(paste0("beta0TIC", seq_along(growth_TIC)),
                                                  paste0("beta1TIC", seq_along(growth_TIC))), byrow = TRUE, name = "beta_TIC"),
          ...
          for (p in 1:Y_nGF){
            BETA[[p]] <- mxPath(from = "lx1", to = latents[p], arrows = 1, free = TRUE, values = starts$beta[p],
      ...
      if (decompose == 0){
        if (!is.null(growth_TIC)){
          ...
          model_mx <- mxModel(name = "LGCM with TVC and TICs, Quadratic Functional Form",
                              type = "RAM", mxData(observed = dat, type = "raw"),
                              manifestVars = manifests, latentVars = latents,
                              mxPath(from = "one", to = latents[1:3], arrows = 1, free = TRUE, values = starts$Y_starts$means,
                              ...
                              mxMatrix("Full", 3, length(growth_TIC), free = TRUE,
                                       values = starts$beta[1:3, seq_along(growth_TIC)],
                                       labels = c(paste0("beta0TIC", seq_along(growth_TIC)),
                                                  paste0("beta1TIC", seq_along(growth_TIC)),
                                                  paste0("beta2TIC", seq_along(growth_TIC))), byrow = TRUE, name = "beta"),
                              mxMatrix("Full", length(growth_TIC), 1, free = TRUE, starts$BL_starts$means[seq_along(growth_TIC)],
                                       labels = c(paste0("mux", seq_along(growth_TIC))), byrow = FALSE, name = "mux"),
                              mxAlgebra(Y_alpha0 + beta %*% mux, name = "Y_mean0"),
                              TVC_info, GF_loadings, BETA)
        ...
        if (!is.null(growth_TIC)){
          ...
          model_mx <- mxModel(name = "LGCM with decomposed TVC and TICs, Quadratic Functional Form",
                              ...
                              mxMatrix("Full", 3, length(growth_TIC), free = TRUE,
                                       ...
                                       labels = c(paste0("beta0TIC", seq_along(growth_TIC)),
                                                  paste0("beta1TIC", seq_along(growth_TIC)),
                                                  paste0("beta2TIC", seq_along(growth_TIC))), byrow = TRUE, name = "beta_TIC"),
      ...
      if (intrinsic){
        ...
        if (decompose == 0){
          if (!is.null(growth_TIC)){
            ...
            BETA[[Y_nGF]] <- mxPath(from = growth_TIC, to = latents[Y_nGF], arrows = 1, free = TRUE, values = starts$beta[Y_nGF, ],
                                    labels = paste0("beta", "g", c(paste0("TIC", seq_along(growth_TIC)))))
            model_mx <- mxModel(name = "LGCM with TVC and TICs, Negative Exponential Functional Form (random ratio)",
                                type = "RAM", mxData(observed = dat, type = "raw"),
                                manifestVars = manifests, latentVars = latents,
                                mxPath(from = "one", to = latents[1:2], arrows = 1, free = TRUE, values = starts$Y_starts$means[1:2],
                                       labels = c("Y_mueta0", "Y_mueta1")),
                                mxMatrix("Full", 1, 1, free = TRUE, values = starts$Y_starts$means[3], labels = "Y_slp_ratio",
                                         name = "Y_mug"),
                                mxPath(from = latents[1:3], to = latents[1:3], arrows = 2, connect = "unique.pairs",
                                       free = TRUE, values = starts$Y_starts$covMatrix,
                                ...
                                mxMatrix("Full", 3, length(growth_TIC), free = TRUE,
                                         ...
                                         labels = c(paste0("beta0TIC", seq_along(growth_TIC)),
                                                    paste0("beta1TIC", seq_along(growth_TIC)),
                                                    paste0("betagTIC", seq_along(growth_TIC))),
                                         byrow = TRUE, name = "beta"),
                                mxMatrix("Full", length(growth_TIC), 1, free = TRUE, starts$BL_starts$means[seq_along(growth_TIC)],
                                         labels = c(paste0("mux", seq_along(growth_TIC))), byrow = FALSE, name = "mux"),
                                mxAlgebra(Y_alpha0 + beta %*% mux, name = "Y_mean0"),
                                TVC_info, GF_loadings, BETA)
          ...
          if (!is.null(growth_TIC)){
            ...
            BETA[[Y_nGF]] <- mxPath(from = c(growth_TIC, "lx1"), to = latents[Y_nGF], arrows = 1, free = TRUE, values = starts$beta[Y_nGF, ],
                                    labels = paste0("beta", "g", c(paste0("TIC", seq_along(growth_TIC)), "TVC")))
            ...
            BETA[[Y_nGF]] <- mxPath(from = "lx1", to = latents[Y_nGF], arrows = 1, free = TRUE, values = starts$beta[Y_nGF],
          ...
          if (!is.null(growth_TIC)){
            ...
            model_mx <- mxModel(name = "LGCM with TVC and TICs, Negative Exponential Functional Form (fixed ratio)",
                                ...
                                mxPath(from = latents[1:2], to = latents[1:2], arrows = 2, connect = "unique.pairs", free = TRUE,
                                       values = starts$Y_starts$covMatrix[c(1:2, 4)], labels = c("Y_psi00", "Y_psi01", "Y_psi11")),
                                mxPath(from = "eta0Y", to = paste0(y_var, records), arrows = 1, free = FALSE, values = 1),
                                mxPath(from = "eta1Y", to = paste0(y_var, records), arrows = 1, free = FALSE, values = 0,
                                       labels = paste0("L1", records, "[1,1]")),
                                mxPath(from = paste0(y_var, records), to = paste0(y_var, records), arrows = 2,
        ...
        if (decompose == 0){
          if (!is.null(growth_TIC)){
            ...
            model_mx <- mxModel(name = "LGCM with TVC and TICs, Jenss Bayley Functional Form (random ratio)",
                                type = "RAM", mxData(observed = dat, type = "raw"),
                                manifestVars = manifests, latentVars = latents,
                                mxPath(from = "one", to = latents[1:3], arrows = 1, free = TRUE, values = starts$Y_starts$means[1:3],
                                       labels = c("Y_mueta0", "Y_mueta1", "Y_mueta2")),
                                mxMatrix("Full", 1, 1, free = TRUE, values = starts$Y_starts$means[4], labels = "Y_acc_ratio",
                                         name = "Y_mug"),
                                ...
                                mxMatrix("Full", 4, length(growth_TIC), free = TRUE,
                                         values = starts$beta[1:4, seq_along(growth_TIC)],
                                         labels = c(paste0("beta0TIC", seq_along(growth_TIC)),
                                                    paste0("beta1TIC", seq_along(growth_TIC)),
                                                    paste0("beta2TIC", seq_along(growth_TIC)),
                                                    paste0("betagTIC", seq_along(growth_TIC))),
                                         byrow = TRUE, name = "beta"),
                                mxMatrix("Full", length(growth_TIC), 1, free = TRUE, starts$BL_starts$means[seq_along(growth_TIC)],
                                         labels = c(paste0("mux", seq_along(growth_TIC))), byrow = FALSE, name = "mux"),
          ...
          if (!is.null(growth_TIC)){
            ...
            model_mx <- mxModel(name = "LGCM with TVC and TICs, Jenss Bayley Functional Form (fixed ratio)",
                                ...
                                mxPath(from = latents[1:3], to = latents[1:3], arrows = 2, connect = "unique.pairs", free = TRUE,
                                       values = starts$Y_starts$covMatrix[c(1:3, 5:6, 8)],
                                       labels = c("Y_psi00", "Y_psi01", "Y_psi02", "Y_psi11", "Y_psi12", "Y_psi22")),
                                mxPath(from = "eta0Y", to = paste0(y_var, records), arrows = 1, free = FALSE, values = 1),
                                mxPath(from = "eta1Y", to = paste0(y_var, records), arrows = 1, free = FALSE, values = 0,
                                       labels = paste0("L1", records, "[1,1]")),
        ...
        if (decompose == 0){
          if (!is.null(growth_TIC)){
            ...
            model_mx <- mxModel(name = "LGCM with TVC and TICs, Bilinear Spline Functional Form (random knot)",
                                ...
                                mxMatrix("Full", 1, 1, free = TRUE, values = starts$Y_starts$means[4], labels = "Y_knot",
                                         name = "Y_mug"),
                                mxPath(from = latents[1:4], to = latents[1:4], arrows = 2, connect = "unique.pairs", free = TRUE,
                                       values = starts$Y_starts$covMatrix,
                                ...
                                mxAlgebra(rbind(cbind(1, -Y_knot, Y_knot, Y_mueta2s - Y_mueta1s),
                                                cbind(0, 1, -1, 0),
                                                cbind(0, 1, 1, 0),
        ...
        if (!is.null(growth_TIC)){
          ...
          model_mx <- mxModel(name = "LCSM with TVC and TICs, Nonparametric Functional Form",
                              ...
                              mxPath(from = "eta1Y", to = paste0("dy", records[-1]), arrows = 1,
                                     free = c(FALSE, rep(TRUE, length(records) - 2)), values = c(1, starts$Y_starts$rel_rate[-1]),
