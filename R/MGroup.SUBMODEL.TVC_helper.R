...
#' @param starts A list of initial values for the parameters, either takes the value passed from \code{getMGroup()}
...
#'
getsub.TVC_m <- function(dat, nClass, grp_var, t_var, y_var, curveFun, intrinsic, records, y_model, TVC, decompose,
                         growth_TIC, starts){
