...
#
# These globalVariables() declarations suppress "no visible binding for global
# variable" notes that R CMD check raises when columns are referenced via
# non-standard evaluation (NSE). This is standard practice for packages that
# use ggplot2 (aes()), dplyr (mutate, filter, select, ...), and tidyr
# (pivot_wider, pivot_longer, ...), where column names are passed as bare
# symbols rather than quoted strings. The variables listed below are not
# actually global; they are column names used inside tidy-evaluation contexts.
utils::globalVariables(c(
  "BL_mean", "M_alpha", "M_alpha0", "M_alpha1", "M_alpha2", "M_alphar", "M_mean",
  "M_mug", "M_psi00", "M_psi01", "M_psi11", "M_psi12", "M_psi1r", "M_psi22",
  "M_psi_r", "M_psir2", "M_psirr", "Omega", "X_mean", "X_mean0",
  "X_mean1", "X_mean2", "X_meanr", "X_mueta0", "X_mueta1", "X_mug", "X_psi0",
  "X_psi00", "X_psi01", "X_psi11", "X_psi12", "X_psi1r", "X_psi22", "X_psir2", "X_psirr", "Y_acc_ratio", "Y_alpha", "Y_alpha0", "Y_alpha1",
  ...
  "Y_psi1gs", "Y_psi1r", "Y_psi22", "Y_psi22s", "Y_psi2g", "Y_psi2gs", "Y_psi_r", "Y_psi_s",
  "Y_psigg", "Y_psiggs", "Y_psir2", "Y_psirr", "Y_slp_ratio", "Ychg_bl_m", "Ychg_bl_v", "Ychg_inv_m",
