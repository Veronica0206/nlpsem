...
```{r}
Figure4 <- getFigure(
  model = Math_BLS_LGCM3_M1[[1]], nClass = 3, cluster_TIC = NULL, sub_Model = "LGCM",
  y_var = "M", curveFun = "BLS", y_model = "LGCM", t_var = "T", records = 1:9,
  m_var = NULL, x_var = NULL, x_type = NULL, xstarts = xstarts, xlab = "Month",
  outcome = "Mathematics"
)
...
Figure5 <- getFigure(
  model = Math_BLS_LGCM3_M2[[1]], nClass = 3, cluster_TIC = c("gx1", "gx2"), 
...
Figure6 <- getFigure(
  model = Math_BLS_LGCM3_M3[[1]], nClass = 3, cluster_TIC = NULL, sub_Model = "LGCM",
  y_var = "M", curveFun = "BLS", y_model = "LGCM", t_var = "T", records = 1:9,
  m_var = NULL, x_var = NULL, x_type = NULL, xstarts = xstarts, xlab = "Month",
  outcome = "Mathematics"
)
